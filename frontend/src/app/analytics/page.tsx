...
import { Fingerprint, BarChart2, Filter, ChevronDown, Activity, AlertCircle, TrendingUp, Users } from "lucide-react";
import { getRankingMetadata } from "@/lib/api";
...
export default function AnalyticsPage() {
  ...
  useEffect(() => {
    getRankingMetadata().then(setData);
  }, []);
      ...
      <main className="pt-20 px-4 md:px-10 max-w-7xl mx-auto w-full flex-1 overflow-y-auto scrollbar-thin pb-20">
        <header className="mb-8 flex justify-between items-end">
          <div>
            ...
            <p className="text-sm text-[#A3A3A3]">Macro-level performance metrics for Req 2026-001.</p>
          </div>
